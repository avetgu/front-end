...
class listenerQuiz extends React.Component {
  ...
  getTrials(stims) {
    ...
    for (let i in stims) {
      ...
      questions = {
        type: 'survey-likert',
        questions: [
          'Think of the singer(s). I think that the singers...',
          'Think of the singer(s). I think that the singers...',
          'Think of the singer(s). I think that the singers...',
          'Think of the singer(s). I think that the singers...',
          'Think of the singer(s). I think that the singers...',
          'Think of the singer(s). I think that the singers...',
          'Did you have trouble hearing this song excerpt?'
        ],
        labels: jsPsych.randomization.shuffle([
          danceScale,
          storyScale,
          mournScale,
          loveScale,
  ...
  componentDidMount() {
    ...
    const explain_requirements = {
      type: 'text',
      text:
        '<p align="left">This study involves listening to sound. You will need to be able to use good quality headphones. Otherwise, you may not be able to complete the study. If you cannot do this, please do not proceed.</p><p>Press any key to continue.</p>'
    };

    const calibration = {
      type: 'text',
      text:
        '<p align="left">On the next screen, you will hear a calibration tone. Listen to the tone, and turn up the volume on your computer until the calibration tone is at a loud but comfortable level. <p>Press any key when you are ready to continue to the tone.</p>'
    };
    ...
    const explain = {
      type: 'text',
      text:
        '<p align="left">In this study, you will listen to excerpts from songs. Each excerpt will be 14 seconds long. You will then answer 6 questions after listening to each excerpt.</p><p align="left">The experiment will begin with a set of training questions concerning an example excerpt. This will have a similar format to the questions that you will see as part of the study.</p> <p>Press any key to continue.</p>'
    };
    ...
    const ready = {
      type: 'text',
      text:
        '<p align="left">You are now ready to start the study. There will be 36 song excerpts for you to listen to.</p> <p>Press any key to continue. Good luck!</p>'
    };
    ...
    const checks = {
      ...
      questions: [
        ...
        'How carefully did you complete this survey?'
      ],
      options: [
        [
        ...
        ['<span class="p">Yes</span>', '<span class="p">No</span>'],
        [
    ...
    const done = {
      type: 'text',
      text:
        '<p align="left">You have now completed the study. Thanks for your participation!</p> <p>Press any key to finish.</p>'
    };
